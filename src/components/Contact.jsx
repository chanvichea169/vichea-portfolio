...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M6.25 3C4.46403 3 3 4.46403 3 6.25V17.75C3 19.536 4.46403 21 6.25 21H17.75C19.536 21 21 19.536 21 17.75V6.25C21 4.46403 19.536 3 17.75 3H6.25ZM6.25 4.5H17.75C18.725 4.5 19.5 5.27497 19.5 6.25V17.75C19.5 18.725 18.725 19.5 17.75 19.5H6.25C5.27497 19.5 4.5 18.725 4.5 17.75V6.25C4.5 5.27497 5.27497 4.5 6.25 4.5ZM12 7.5V10H14.5L14 13H12V21H9V13H7V10H9V7.5C9 6.1 9.5 5 11.5 5H14V7H12.5C12.1 7 12 7.2 12 7.5Z"
          fill="currentColor"
        />
      </svg>
    ),
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/bkkyrpgb"
          method="POST"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-6">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                required
                autoComplete="email"
                placeholder="chanvichea169@gmail.com"
                className="text-field w-full reveal-up"
              />
            </div>
          </div>
